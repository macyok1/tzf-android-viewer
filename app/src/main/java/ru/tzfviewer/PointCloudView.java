...
public final class PointCloudView extends GLSurfaceView {
    ...
    private static final class CloudRenderer implements GLSurfaceView.Renderer {
        ...
        void beginGizmo(float x,float y){if(activeTargetNodeId==null||activeSceneIds.isEmpty()||!inverseMvpValid){gizmo.endDrag();return;}updateGizmoPivot();gizmo.beginDrag(x,y,transform,gizmoPivot,primaryMvp,inversePrimaryMvp,width,height);}
