...
public final class PointCloudView extends GLSurfaceView {
    ...
    private static final class CloudRenderer implements GLSurfaceView.Renderer {
        ...
        void setSceneCloudTransform(String id,float[] pose){SceneCloud c=sceneClouds.get(id);if(c!=null){System.arraycopy(pose,0,c.pose,0,Math.min(4,pose.length));updateActivePivot();}}
