...
public final class SettingsActivity extends Activity {
    ...
    private void renderChannel(){versionView.setText("Версия "+BuildConfig.VERSION_NAME+" ("+BuildConfig.VERSION_CODE+")");channelView.setText("Канал обновлений: "+(nightlyEnabled()?"ночной":"стабильный"));}
