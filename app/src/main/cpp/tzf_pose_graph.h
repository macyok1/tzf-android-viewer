...
struct PoseGraphOptions { int maximumIterations{80}; double translationTolerance{1e-5}; double yawToleranceDegrees{1e-4}; double robustTranslationScale{.05}; double robustYawScaleDegrees{2}; double maximumEdgeResidual{.15}; double maximumMeanEdgeResidual{.05}; const std::atomic_bool* cancellation{}; };
